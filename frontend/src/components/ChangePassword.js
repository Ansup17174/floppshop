    ...
    return (
        <div className="register">
            <form className="login-form" onSubmit={handleSubmit}>
                ...
                {responseOk && <div className="register-success">Password changed</div>}
                <div className="register-field">
                    <input type="password" className="register-input" placeholder="Old password" value={oldPassword} onChange={e => setOldPassword(e.target.value)}/>
                    {errors.old_password && errors.old_password.map((message, index) => <div className="register-fail" key={index}>{message}</div>)}
                </div>
                <div className="register-field">
                ...
                <input type="submit" className="register-button register-input" value="Change password"/>
            </form>
        </div>
    );
};  
